...
function createElement(tag, data, options = {}) {
  ...
  function initPage(){
      ...
      Atalk.appendChild(createElement("span","Hi, in here, you could ask questions about python open source project coding.\
      If you want to ask any specific function to python type, please input eg: String type function first then begin search.",{id:"asay"}))
      ...
      talk_input.appendChild(createElement("input", null, { type: "button", value:"Switch",class: "talk_sub" ,id: "Mentor_mode" }))
