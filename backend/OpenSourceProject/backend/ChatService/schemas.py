...
validators = {
    ('chatbot', 'GET'): {'headers': {'required': ['Token'], 'properties': {'Token': {'type': 'string'}}}, 'args': {'required': ['message', 'huaci'], 'properties': {'message': {'type': 'string'}, 'huaci': {'type': 'boolean'}}}},
    ('user_register', 'POST'): {'json': {'$ref': '#/definitions/User'}},
    ('user_login', 'GET'): {'args': {'required': ['email', 'password'], 'properties': {'email': {'description': 'The email for login', 'type': 'string'}, 'password': {'description': 'The password for login in clear text', 'type': 'string'}}}},
}

filters = {
    ('chatbot', 'GET'): {200: {'headers': None, 'schema': None}, 401: {'headers': None, 'schema': None}},
    ('user_register', 'POST'): {},
